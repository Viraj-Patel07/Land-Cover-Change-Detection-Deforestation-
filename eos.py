# -*- coding: utf-8 -*-
"""
Created on Tue Nov 21 19:17:28 2023
...
df = pd.read_csv('C:/HARSH/EOS_project/MAIN/csv/point_raster_2000.csv')
# for 1st 5 rows
df.head()
...
classes = ['1 =VEGETATION', '2 = SNOW ']
ax.set_title('Percentages of the Predictions of Each Class for 2000')
